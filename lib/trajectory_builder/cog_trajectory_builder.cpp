...
namespace MouseTrack {
    ...
    /// Creates a new control point for a trajectory from a cluster and its descriptor
     Eigen::Vector3d CogTrajectoryBuilder::operator()(const std::shared_ptr<const ClusterDescriptor> descriptor, const Cluster& cluster, const PointCloud& cloud) const {
