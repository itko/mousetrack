...
$APP -c -s $SRC -l trace --pipeline-timer -o $OUT ${FRAMES} --pipeline-frame-window-filtering=background-subtraction --background-subtraction-cage-directory=$SRC --pipeline-clustering=single-cluster 
