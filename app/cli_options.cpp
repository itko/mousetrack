...
op::options_description cli_options(){
    ...
    desc.add_options()
      ...
      ("subsample-to", op::value<int>()->default_value(100*000), "Subsample the points cloud such that there are only <n> points.")
      ("mean-shift-sigma", op::value<double>()->default_value(0.01), "Sigma used for the mean-shift clustering.")
      ("mean-shift-max-iterations", op::value<int>()->default_value(1000), "Maximum number of iterations for a point before it should converge.")
      ("mean-shift-merge-threshold", op::value<double>()->default_value(0.001), "Maximum distance of two clusters such that they can still merge")
      ("mean-shift-convergence-threshold", op::value<double>()->default_value(0.0001), "Maximum distance a point is allowed to travel in an iteration and still being classified as converged.")
      ;
    return desc;
}
